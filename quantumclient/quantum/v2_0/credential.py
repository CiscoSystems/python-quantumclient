...
class ListCredential(ListCommand):
...
class ShowCredential(ShowCommand):
...
class CreateCredential(CreateCommand):
    ...
    def args2body(self, parsed_args):
        ...
        if parsed_args.username:
            body['credential'].update({'user_name': parsed_args.username})
